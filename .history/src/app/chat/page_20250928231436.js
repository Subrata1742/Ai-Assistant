    ...
    <div className="min-h-screen w-full flex justify-center items-center ">
      <Card className="w-full md:max-w-[70vw] max-w-xl mt-18 flex-grow overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg lg:w-1/2">
        <CardContent className="p-0">
          ...
          components={{
            // ## Headings
            h1: ({node, ...props}) => <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4 pb-2 border-b border-gray-300 dark:border-gray-600" {...props} />,
            h2: ({node, ...props}) => <h2 className="text-3xl font-semibold text-gray-800 dark:text-gray-200 mt-8 mb-4 pb-2 border-b border-gray-200 dark:border-gray-700" {...props} />,
            h3: ({node, ...props}) => <h3 className="text-2xl font-semibold text-gray-800 dark:text-gray-200 mt-6 mb-4" {...props} />,
            ...
            // ## Lists
            ul: ({node, ...props}) => <ul className="list-disc list-inside mb-4 pl-4 space-y-2 text-gray-700 dark:text-gray-300" {...props} />,
            ol: ({node, ...props}) => <ol className="list-decimal list-inside mb-4 pl-4 space-y-2 text-gray-700 dark:text-gray-300" {...props} />,
            li: ({node, ...props}) => <li className="pb-1" {...props} />,

            // ## Blockquotes
            blockquote: ({node, ...props}) => <blockquote className="border-l-4 border-blue-500 pl-4 py-2 my-4 text-gray-600 dark:text-gray-400 italic bg-gray-50 dark:bg-gray-700/50 rounded-r-md" {...props} />,
            
            // ## Tables
            table: ({node, ...props}) => <div className="overflow-x-auto my-6"><table className="w-full text-sm text-left shadow-md rounded-lg" {...props} /></div>,
            thead: ({node, ...props}) => <thead className="text-xs text-gray-700 uppercase bg-gray-100 dark:text-gray-300 dark:bg-gray-700" {...props} />,
            tbody: ({node, ...props}) => <tbody className="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700" {...props} />,
            tr: ({node, ...props}) => <tr className="hover:bg-gray-50 dark:hover:bg-gray-600" {...props} />,
            th: ({node, ...props}) => <th className="px-6 py-3 font-medium tracking-wider" {...props} />,
            ...
            code({ node, inline, className, children, ...props }) {
              ...
              // Inline code
              return (
                <code className="font-mono text-sm bg-gray-200 dark:bg-gray-700 text-purple-600 dark:text-purple-400 rounded-md px-1.5 py-1" {...props}>
                  {children}
                </code>
              );
            },
