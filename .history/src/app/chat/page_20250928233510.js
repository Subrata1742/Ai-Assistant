      ...
      <Card className="w-full md:max-w-[70vw] max-w-xl mt-18 flex-grow overflow-hidden rounded-xl border border-gray-200 bg-white shadow-lg lg:w-1/2">
        <CardContent className="p-0">
          ...
          components={{
            ...
            ul: ({node, ...props}) => <ul className="list-disc list-outside mb-4 pl-6 space-y-3" {...props} />,
            ol: ({node, ...props}) => <ol className="list-decimal list-outside mb-4 pl-6 space-y-3" {...props} />,
