                            ...
                            >
                              ...
                              <ReactMarkdown
                                ...
                                components={{
                                  ...
                                  ul: ({ node, ...props }) => (
                                    <ul
                                      className="list-disc list-inside mb-4 pl-4 space-y-2 text-gray-700 dark:text-gray-300"
                                      {...props}
                                    />
                                  ),
                                  ol: ({ node, ...props }) => (
                                    <ol
                                      className="list-decimal list-inside mb-4 pl-4 space-y-2 text-gray-700 dark:text-gray-300"
                                      {...props}
                                    />
                                  ),
                                  li: ({ node, ...props }) => (
                                    <li className="pb-1" {...props} />
                                  ),

                                  // ## Blockquotes
                                  blockquote: ({ node, ...props }) => (
                                    <blockquote
                                      className="border-l-4 border-blue-500 pl-4 py-2 my-4 text-gray-600 dark:text-gray-400 italic bg-gray-50 dark:bg-gray-700/50 rounded-r-md"
                                      {...props}
                                    />
                                  ),
                                  ...
                                  table: ({ node, ...props }) => (
                                    <div className="overflow-x-auto my-6">
                                      <table
                                        className="w-full text-sm text-left shadow-md rounded-lg"
                                        {...props}
                                      />
                                    </div>
                                  ),
                                  thead: ({ node, ...props }) => (
                                    <thead
                                      className="text-xs text-gray-700 uppercase bg-gray-100 dark:text-gray-300 dark:bg-gray-700"
                                      {...props}
                                    />
                                  ),
                                  tbody: ({ node, ...props }) => (
