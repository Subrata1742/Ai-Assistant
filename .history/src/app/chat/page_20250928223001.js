                          ...
                          return (
                            ...
                            >
                              <ReactMarkdown
                                ...
                                components={{
                                  // ✅ FIX: Robustly handles paragraphs to prevent hydration errors
                                  p: ({ node, children }) => {
                                    // Helper to find nested code blocks
                                  ...
                                  // ✅ IMPROVED: Handles both inline and block code gracefully
                                  code: ({
                                    node,
                                    inline,
                                    className,
                                    ...
                                    return (
                                      <div className="my-4 rounded-md overflow-hidden bg-slate-900 text-white">
                                        {match && (
                                          <div className="bg-slate-800 px-4 py-1 text-xs font-sans text-slate-400">
                                            {match[1]}
                                          </div>
                                        )}
                                  ...
                                  // ✅ IMPROVED: Consistent list styling
                                  ul: ({ node, ...props }) => (
                                    <ul
