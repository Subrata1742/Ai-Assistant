  ...
  // console.log(result);
    ...
    return result.toUIMessageStreamResponse({
      ...
      await prisma.message.create({
       ...
       if (!chat.title) {
          const titlePrompt = `Create a short, concise title (5 words or less) for the following conversation:\n\n role: ${responseMessage.role}\n part: ${ responseMessage.parts }`;
          
          // Use 'generateText' for a simple, non-streaming AI call
