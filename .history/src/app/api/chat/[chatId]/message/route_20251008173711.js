  ...
  try {
    ...
    const result = streamText({
      ...
      messages: [
        {
          ...
          - Use 'web_search' when the user asks for real-world or current information.
      ...
      tools: {
        ...
        // web_search: tool({
        //   description:
        //     "Perform a Google search and summarize findings in an insightful, expert-level tone.",
