    ...
    const result = streamText({
      ...
      tools: {
        ...
        // url_context: google.tools.urlContext({}),
          google_search: tool({
        description: "Search Google and summarize the results",
        ...
        execute: async ({ query }) => {
          ...
          const { text: summary } = await generateText({
            model: google("gemini-2.5-flash"),
            prompt: `Summarize the following search results about "${query}" into a short, clear explanation:\n\n${textResults}`,
          });
