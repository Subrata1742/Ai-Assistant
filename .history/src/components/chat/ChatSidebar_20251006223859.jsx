        ...
        {chats.map((c) => (
          <li key={c.id}>
            ...
            ><div className=" overflow-x-hidden mr-3">
              {c.title?c.title:"New Chat"}</div><Button className="bg-transparent text-black hover:bg-transparent" onClick={(e)=>handleDelete(e,c.id)}><BiDotsVerticalRounded  /></Button>
            </Button>
          </li>
        ))}
      </ul>
