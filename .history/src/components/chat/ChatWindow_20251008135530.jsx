    ...
    <div className="h-full w-full flex justify-center  items-center ">
      <Card className="w-full md:max-w-[70vw] max-w-xl flex-grow rounded-xl border border-gray-200 bg-white shadow-lg lg:w-1/2">
        <CardContent className="p-0">
          <div className="flex md:h-[80vh] h-[90vh] flex-col overflow-y-hidden">
            ...
            <form onSubmit={handleSubmit}>
              {files?.length
                      ? <div className="w-full py-2 border-t rounded-t-2xl text-center bg-gray-100">{`${files.length} file${
                          files.length > 1 ? "s" : ""
                        } attached`}</div>
                      : ""}
