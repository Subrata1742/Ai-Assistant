...
const HomePage = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 text-gray-900 antialiased">
      {/* Hero Section */}
      <motion.section
        className="container flex w-full h-screen max-w-4xl flex-col items-center justify-center p-6 text-center mt-12 pb-16 lg:p-12"
      ...
      <motion.section
        className="container mt-16 flex w-full mb-4 max-w-6xl flex-col items-center justify-center gap-12 p-6 lg:flex-row"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
