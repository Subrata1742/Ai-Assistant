...
const HomePage = () => {
  ...
  return (
    <div className="flex min-h-screen overflow-auto scrollbar-hide flex-col items-center justify-center bg-gray-50 text-gray-900 antialiased">
      {/* Hero Section */}
      <motion.section
      ...
      <motion.section
        ...
        id='features'
        className="container mt-16 flex w-full h-screen  max-w-6xl flex-col items-center justify-center gap-12 p-6 lg:flex-row"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
