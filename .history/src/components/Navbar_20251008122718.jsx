...
const Navbar = () => {
  ...
  return (
    <nav className={`${showNav? "hidden md:not-sr-only":""} fixed left-0 right-0 top-0 z-50 flex h-16 items-center justify-between border-b border-gray-200 bg-white/70 px-4 backdrop-blur-md md:px-8`}>
      {/* Logo and App Name */}
      <Link href="/">
